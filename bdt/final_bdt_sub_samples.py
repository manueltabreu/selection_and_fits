...
sig_list = [
          'sub_samples/sample_MC_LMNR_0.root',
          'sub_samples/sample_MC_LMNR_1.root',
          'sub_samples/sample_MC_LMNR_2.root',
          'sub_samples/sample_MC_LMNR_3.root',
          'sub_samples/sample_MC_LMNR_4.root',
          'sub_samples/sample_MC_LMNR_5.root',
          'sub_samples/sample_MC_LMNR_6.root',
          'sub_samples/sample_MC_LMNR_7.root',
          'sub_samples/sample_MC_LMNR_8.root',
          'sub_samples/sample_MC_LMNR_9.root',
          'sub_samples/sample_MC_LMNR_10.root',
]
...
for isample in range(11):
    ...
    tag = '_preliminary_Iso_firstOptimization_conda_%s'%isample
...
#     import pdxb; pdb.set_trace()
    clf = XGBClassifier(
        ...
        learning_rate    = 0.4,
        max_delta_step   = 0.04181009005688081,
        min_child_weight = 4.76,
        n_estimators     = 510,
        max_depth        = 5,
        subsample        = 0.67,
        gamma            = 0.33,     
