...
void create_subsample(){
  ...
  tree -> Add("/gwteray/users/fiorendi/data2018/p5prime/flat_ntuples/Apr30/ntuple_2018A_Charmonium.root");
  tree -> Add("/gwteray/users/fiorendi/data2018/p5prime/flat_ntuples/Apr30/ntuple_2018B_Charmonium.root");
  tree -> Add("/gwteray/users/fiorendi/data2018/p5prime/flat_ntuples/Apr30/ntuple_2018C_Charmonium.root");
  tree -> Add("/gwteray/users/fiorendi/data2018/p5prime/flat_ntuples/Apr30/ntuple_2018D_Charmonium.root");
  
  std::vector<TFile*> out_files;
  for (int i=0; i < n_subsamples; i++){
      TFile* ifile = new TFile(Form("sub_samples/sample_data_%d.root", i),"RECREATE");
