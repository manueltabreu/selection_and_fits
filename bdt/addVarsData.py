...
for str_file in samples:
    ...
    for i in range(1):
        input_files = []
        input_files.append('../final_ntuples/%s%s_newphi_punzi_noTkMu_B0PsiFlag.root'%(args.year, str_file ))        
        ofile = '../final_ntuples/%s%s_newphi_punzi_noTkMu_B0PsiFlag_addVars_sept2021.root'%(year, str_file)
