...
sig_list = [
          'sub_samples/sample_2016_MC_LMNR_0_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_1_newphi.root',
          'sub_samples/sample_2016_MC_LMNR_2_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_3_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_4_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_5_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_6_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_7_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_8_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_9_newphi.root', 
          'sub_samples/sample_2016_MC_LMNR_10_newphi.root',
]

bkg_list = [
          'sub_samples/sample_2016_data_LMNR_0_newphi.root',
          'sub_samples/sample_2016_data_LMNR_1_newphi.root',
          'sub_samples/sample_2016_data_LMNR_2_newphi.root',
          'sub_samples/sample_2016_data_LMNR_3_newphi.root',
          'sub_samples/sample_2016_data_LMNR_4_newphi.root',
          'sub_samples/sample_2016_data_LMNR_5_newphi.root',
          'sub_samples/sample_2016_data_LMNR_6_newphi.root',
          'sub_samples/sample_2016_data_LMNR_7_newphi.root',
          'sub_samples/sample_2016_data_LMNR_8_newphi.root',
          'sub_samples/sample_2016_data_LMNR_9_newphi.root',
          'sub_samples/sample_2016_data_LMNR_10_newphi.root',
]

for isample in range(11):

    tag = '_punzi_removeTkMu_fixBkg_2016_%s'%isample
...
# {'params': {'colsample_bytree': 0.8114939866308136, 'learning_rate': 0.12840653874464483, 'max_delta_step': 0.08810449485681739, 
# 'min_child_weight': 8.935379758961956, 'n_estimators
# ': 857.5144182210818, 'subsample': 0.7586399447771304, 'max_depth': 8.05997406623625, 'gamma': 0.03333132019207767}, 'target': 629.2284827327096}
#     clf = XGBClassifier(
#         colsample_bytree = 0.981,
#         learning_rate    = 0.13,
#         max_delta_step   = 0.088,
...
## mumuMass also above 4
#{'params': {'colsample_bytree': 0.7354454177838312, 'learning_rate': 0.25611605047417224, 
#'max_delta_step': 0.04622510125719819, 'min_child_weight': 7.685086517694214, 
#'n_estimators': 800.413314687647, 'subsample': 0.7760244291460664, 'max_depth': 9.198839065285075, 'gamma': 0.1661279972711428}, 'target': 954.1094774161289}
# {'params': {'colsample_bytree': 0.6408376073909328, 'learning_rate': 0.28798128791157857, 
# 'max_delta_step': 0.06321627008516677, 'min_child_weight': 3.9506708310576197, 
# 'n_estimators': 823.3330824837028, 'subsample': 0.7126842148313935, 'max_depth': 7.936666138840077, 
# 'gamma': 0.8776221424114137}, 'target': 973.7054288878331}

## new correct hlt
# {'params': {'colsample_bytree': 0.5784076291159914, 'learning_rate': 0.23556479603511227, 
# 'max_delta_step': 0.1176842086119728, 'min_child_weight': 6.618764498206192, 
# 'n_estimators': 506.9153669014661, 'subsample': 0.7326910418928613, 
# 'max_depth': 9.446982996620306, 'gamma': 0.8691763424768162}, 'target': 967.8522655284478}
## fix bkg
# {'params': {'colsample_bytree': 0.8627797998796948, 
# 'learning_rate': 0.37436336083883376, 'max_delta_step': 0.02378447127465308, 
# 'min_child_weight': 2.373242601243865, 'n_estimators': 707.900538020536, 'subsample': 0.6310014642551183, 'max_depth': 5.9304885900890465, 'gamma': 0.22493885111870715}, 'target': 1340.609329526587}

    clf = XGBClassifier(
        colsample_bytree = 0.863,
        learning_rate    = 0.374,
        max_delta_step   = 0.024,
...
#         learning_rate    = 0.288,
#         max_delta_step   = 0.063,
#         min_child_weight = 3.95,
#         n_estimators     = 820,
#         max_depth        = 8,
#         subsample        = 0.71,
#         gamma            = 0.88,     
