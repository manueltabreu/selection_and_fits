...
sig_list = [
          'sub_samples/sample_2017_MC_LMNR_0_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_1_newphi.root',
          'sub_samples/sample_2017_MC_LMNR_2_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_3_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_4_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_5_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_6_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_7_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_8_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_9_newphi.root', 
          'sub_samples/sample_2017_MC_LMNR_10_newphi.root',
]

bkg_list = [
          'sub_samples/sample_2017_data_LMNR_0_newphi.root',
          'sub_samples/sample_2017_data_LMNR_1_newphi.root',
          'sub_samples/sample_2017_data_LMNR_2_newphi.root',
          'sub_samples/sample_2017_data_LMNR_3_newphi.root',
          'sub_samples/sample_2017_data_LMNR_4_newphi.root',
          'sub_samples/sample_2017_data_LMNR_5_newphi.root',
          'sub_samples/sample_2017_data_LMNR_6_newphi.root',
          'sub_samples/sample_2017_data_LMNR_7_newphi.root',
          'sub_samples/sample_2017_data_LMNR_8_newphi.root',
          'sub_samples/sample_2017_data_LMNR_9_newphi.root',
          'sub_samples/sample_2017_data_LMNR_10_newphi.root',
]

for isample in range(11):

    tag = '_punzi_removeTkMu_fixBkg_2017_%s'%isample
...
##########################################################################################
    ...
    plt.savefig('mass_bkg_2017.pdf')
    sig.hist(column='themass',bins=400)   
    plt.savefig('mass_sig_2017.pdf')
...
#{'params': {'colsample_bytree': 0.9254025816863582, 'learning_rate': 0.11951475521677518, 
#'max_delta_step': 0.09589851708320196, 'min_child_weight': 2.674592118363184, 'n_estimators
#': 817.5085988025977, 'subsample': 0.6469411413379482, 'max_depth': 7.423678542443454, 'gamma': 0.32088325983516086}, 'target': 706.4901686753113}

# {'params': {'colsample_bytree': 0.6696668742336832, 'learning_rate': 0.21619372736277281, 'max_delta_step': 0.12747390073821452, 'min_child_weight': 3.8771823444237437, 'n_estimators': 564.5511430129607, 'subsample': 0.6311424312384986, 'max_depth': 4.224127403748022, 'gamma': 0.5480911640172041}, 'target': 1172.106884824251}

    clf = XGBClassifier(
        colsample_bytree = 0.67,
        learning_rate    = 0.22,
        max_delta_step   = 0.123,
...
#         learning_rate    = 0.12,
#         max_delta_step   = 0.0959,
#         min_child_weight = 2.67,
#         n_estimators     = 817,
#         max_depth        = 7,
#         subsample        = 0.65,
#         gamma            = 0.32,     
